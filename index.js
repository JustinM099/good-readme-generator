...
// This should include what the app is for, how to use the app, how to install it, how to report issues, and how to make 
// contributions—this last part increases the likelihood that other developers will contribute to the success of the project.
...
// file from a user's input using the Inquirer package. Review the Professional README Guide as a reminder of everything 
// that a high-quality, professional README should contain.

// The application will be invoked by using the following command:

// // node index.js
// // Because this application won’t be deployed, you’ll also need to provide a link to a walkthrough video that 
// demonstrates its functionality. Revisit the Screencastify Tutorial in the prework as a refresher on how to record 
// video from your computer. You’ll need to submit a link to the video and add it to the README of your project.
...
// // A walkthrough video that demonstrates the functionality of the README generator must be submitted, and a link to 
// the video should be included in your README file.

// // The walkthrough video must demonstrate how a user would invoke the application from the command line.

// // The walkthrough video must demonstrate how a user would enter responses to all of the prompts in the application.

// // The walkthrough video must demonstrate a generated README that matches the user input and has a functioning 
// table of contents.
